...
@push('scripts')
    <script>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return data === 1 ? 'Admin Gudang' : 'Karyawan';
                        }
                    },
                    {
                        data: 'aksi',
        ...
        function addForm(url) {
            ...
            $('#modal-form .modal-title').text('Tambah User'); // Ganti judul modal.
            ...
            $('#modal-form [name=name]').focus(); // Fokuskan ke input Deskripsi.
        ...
        function editForm(url) {
            $('#modal-form').modal('show'); // Tampilkan modal.
            $('#modal-form .modal-title').text('Edit User'); // Ganti judul modal.

            $('#modal-form form')[0].reset(); // Reset form jika ada data lama.
            $('#modal-form form').attr('action', url); // Atur URL action form.
            $('#modal-form [name=_method]').val('put'); // Tentukan method untuk form (PUT).
            $('#modal-form [name=name]').focus(); // Fokuskan ke input name.
