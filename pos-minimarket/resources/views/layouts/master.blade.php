...
<body class="hold-transition skin-purple-light sidebar-mini fixed wysihtml5-supported">
    <div class="wrapper">
        ...
        <aside class="control-sidebar control-sidebar-dark" style="display: none;">
            ...
            <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
                <li><a href="{{ asset('#control-sidebar-home-tab') }}" data-toggle="tab"><i
                            class="fa fa-home"></i></a></li>
                <li><a href="{{ asset('#control-sidebar-settings-tab') }}" data-toggle="tab"><i
