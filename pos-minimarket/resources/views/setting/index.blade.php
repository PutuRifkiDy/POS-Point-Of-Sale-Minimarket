                ...
                <form action="{{route('setting.update')}}" method="post" class="form-setting" data-toggle="validator" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <textarea name="alamat" class="form-control" id="alamat" required rows="3" style="resize: none;" required></textarea>
                                <span class="help-block with-errors"></span>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="path_kartu_member" class="col-lg-2 col-lg-offset-1 control-label">Desain Member Card</label>
                            <div class="col-lg-4">
    ...
    <script>
        ...
        function showData(){
            ...
            .done(response => {
                ...
                $('.kartu-member').html(`<img src="{{ url('/') }}${response.path_kartu_member}" width="200"> `);
            })
            .fail(errors => {
                Swal.fire({
                    title: 'Gagal!',
